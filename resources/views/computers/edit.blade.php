                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ isset($computer) ? route('computers.update', $computer) : route('computers.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            @error('serial_number') <p class="text-red-400 text-xs italic">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @error('model') <p class="text-red-400 text-xs italic">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @error('brand') <p class="text-red-400 text-xs italic">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @error('commissioned_at') <p class="text-red-400 text-xs italic">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @error('network_id') <p class="text-red-400 text-xs italic">{{ $message }}</p> @enderror
                        </div>
